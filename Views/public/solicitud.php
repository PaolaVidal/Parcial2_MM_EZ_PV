      ...
      <div class="card-body">
        ...
        <div class="alert alert-info">
          ...
          <ul class="mb-0 small">
            ...
            <li>Ahora puedes solicitar cambios en: <strong>Nombre, Email, Teléfono, Dirección, Fecha de Nacimiento y
                DUI</strong></li>
            <li>El cambio de DUI será revisado con mayor rigurosidad (proporciona un motivo claro)</li>
        ...
        <form method="post">
          <div class="mb-3">
            <label class="form-label"><i class="fas fa-list"></i> Campo a Modificar <span
          ...
          <div class="mb-3">
            ...
            <input type="text" name="valor" class="form-control"
              placeholder="Ingresa el nuevo valor (para DUI: ########-#)" required maxlength="200">
            <small class="text-muted">Escribe el nuevo valor que deseas para el campo seleccionado. Para DUI usa el
              formato 00000000-0</small>
          </div>

          <div class="mb-3">
            <label class="form-label"><i class="fas fa-comment"></i> Motivo del Cambio (Opcional)</label>
            <textarea name="motivo" class="form-control" rows="3"
              placeholder="Explica brevemente por qué necesitas este cambio" maxlength="500"></textarea>
